        ...
        <section className={`edit-product p-16`}>
                ...
                <div className="info-product p-6 bg-awashama-white mt-4 rounded-xl mb-4">
                    ...
                    <div className="form-style grid grid-cols-2 gap-2 items-center">
                        ...
                        <input type="text" name="foto" id="foto" className="border border-solid rounded-xl p-2" placeholder="Masukkan url foto" defaultValue={artikel?.foto}/>

                        <label htmlFor="judul" className="p-2">Judul artikel</label>
                        <input type="text" name="judul" id="judul" className="border border-solid rounded-xl p-2" placeholder="Masukkan judul artikel" defaultValue={artikel?.judul}/>

                        <label htmlFor="tempat" className="p-2">Tempat ditemukan artikel</label>
                        <input type="text" name="tempat" id="tempat" className="border border-solid rounded-xl p-2" placeholder="Masukkan tempat dan tanggal" defaultValue={artikel?.tempat}/>

                        <label htmlFor="sumber" className="p-2">Sumber artikel</label>
                        <input type="text" name="sumber" id="sumber" className="border border-solid rounded-xl p-2" placeholder="Masukkan sumber artikel" defaultValue={artikel?.sumber} />

                        <label htmlFor="kategori" className="p-2">Kategori artikel</label>
                        <input type="text" name="kategori" id="kategori" className="border border-solid rounded-xl p-2" placeholder="Masukkan kategori artikel" defaultValue={artikel?.kategori} />
